...
source_name: "xAI"
significance: high
body_zh: "xAI 开源 Grok-1，将 314B 参数的 MoE 模型权重和架构以 Apache 2.0 协议放到 GitHub 和 Hugging Face。Grok-1 是 2023 年 10 月完成预训练的原始基座模型，未做对话微调——当时开源过的最大模型之一。这次开源大幅抬高了开源 AI 生态能触及的天花板。"
---
