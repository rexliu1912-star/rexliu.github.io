---
title: "I Made ¥72,000 on Gold ETF in 152 Days. Here's What I Did Right and Wrong."
description: "A full breakdown of my Gold ETF (518880) trade — the entries, exits, mistakes, and rules for next time."
...
1. **Entry**: wait for daily close confirmation, not intraday drops. One extra day of patience beats catching a falling knife.

2. **Profit-taking**: set price-level targets. Upper band = sell 30%. Another 5% up = sell another 30%.

3. **Reloading**: one entry at one price level after stabilization. Not three panic buys across a 12% range on the same day.

4. **Exit**: when the weekly mid-rail breaks, pre-set the limit order the night before. Do not wait for market open to decide.

5. **ETF timing gap**: decisions made at night, prices changed by morning. Solution: always use limit orders, placed in advance.
